...
# Sample data
data = {
    "Seller ID": ["S447", "S126", "S873", "S563", "S416", "S148", "S329", "S848", "S302", "S321"],
    "Seller Name": ["Seller S447", "Seller S126", "Seller S873", "Seller S563", "Seller S416", "Seller S148", "Seller S329", "Seller S848", "Seller S302", "Seller S321"],
    "City, State": ["Chennai, Tamil Nadu", "Bengaluru, Karnataka", "Chennai, Tamil Nadu", "Mumbai, Maharashtra", "Mumbai, Maharashtra", "Srinagar, J&K", "Mumbai, Maharashtra", "Delhi, NCR", "Bengaluru, Karnataka", "Srinagar, J&K"],
    "Brands Offered": [['Pigeon', 'boAt', 'Mysore Silk Sarees', 'Bajaj'], ['Bajaj', 'Havells', 'Zebronics'], ['Mysore Silk Sarees', 'Pigeon', 'boAt', 'Kanchipuram Saris'], ['Manyavar', 'Zebronics', 'Havells', 'Usha'], ['Pigeon', 'Lava Mobiles', 'Kanchipuram Saris'], ['Kanchipuram Saris', 'Manyavar', 'Lava Mobiles'], ['Pigeon'], ['Bajaj', 'Lava Mobiles', 'Usha', 'Havells'], ['boAt', 'Pigeon', 'Usha', 'Flipkart (in-house)'], ['Kanchipuram Saris', 'Usha']],
    "Product Categories": [['Accessories'], ['Home Decor', 'Appliances', 'Electronics', 'Accessories'], ['Mobiles', 'Home Decor', 'Clothing', 'Appliances'], ['Bakeware', 'Mobiles', 'Handicrafts'], ['Bakeware'], ['Accessories', 'Clothing', 'Home Decor', 'Handicrafts'], ['Clothing', 'Kitchenware'], ['Ethnic Wear', 'Home Decor', 'Mobiles', 'Clothing'], ['Kitchenware', 'Handicrafts'], ['Ethnic Wear', 'Mobiles', 'Electronics', 'Kitchenware']],
    "Average Rating": [4.1, 4.9, 4.2, 5.0, 4.7, 4.7, 4.5, 4.2, 4.8, 4.4],
    "Number of Reviews": [13.0, 19.5, 16.6, 6.7, 15.9, 18.8, 12.8, 12.4, 17.2, 15.6],
    "Total Sales": [25.4, 44.5, 11.8, 36.6, 35.8, 20.0, 24.9, 29.3, 9.1, 10.1],
    "Average Order Value (₹)": [1054, 1012, 4283, 4109, 4242, 3075, 4306, 2923, 4115, 4281],
    "Response Time (hrs)": [9, 13, 1, 5, 1, 14, 1, 9, 6, 16]
}
